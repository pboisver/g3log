...
namespace g3 {
   ...
   namespace internal {
      ...
      bool shouldBlockForFatalHandling() { return false; }

      /** \return signal_name Ref: signum.hpp and \ref installSignalHandler
      *  or for Windows exception name */
      std::string exitReasonName(const LEVELS& level, g3::SignalType signal_number) { return "FakeExitReason"; }

      /** return calling thread's stackdump*/
      std::string stackdump(const char* dump) { return "";}
